...
<article class="va-single-event">
	...
	<div class="va-container va-section">
		...
		<div class="va-single-event__details">
			<?php if ( $price ) : ?>
				<p class="va-single-event__price">
					<strong><?php esc_html_e( 'Price:', 'visitaylesbury' ); ?></strong>
					<?php echo esc_html( $price ); ?>
				</p>
			<?php endif; ?>

			<?php if ( $ticket_url ) : ?>
				<p class="va-single-event__tickets">
					<a href="<?php echo esc_url( $ticket_url ); ?>" class="va-single-event__btn" target="_blank" rel="noopener noreferrer">
